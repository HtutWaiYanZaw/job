...
@section('content')
    ...
    <hr>
    <form action="{{ url('admin/employee/' . $employees->id) }}" method="post" novalidate>
        @csrf()
        @method('put')
        ...
        <div class="mb-3">
            ...
            value="{{ old('full_name',$employees->full_name) }}">
        ...
        <div class="mb-3">
            ...
            value="{{ old('company_id',$employees->company_id) }}">
        ...
        <div class="mb-3">
            ...
            value="{{ old('emails',$employees->email) }}">
